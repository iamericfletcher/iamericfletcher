...
I am also busy teaching myself the `R` and `Python` programming languages. My focus lies in understanding statistical analysis, data manipulation, and data visualization. My overarching goal is to deepen my problem solving skills while continuing to broaden my administratively focused skill set with the ability to harness data science techniques to help my Executive, or fellow team members, derive insight from data. Eventually, I would also like to inspire other administrative professionals to learn how to code!
